...
import DeferredHouseStageV8 from "@/components/DeferredHouseStageV8";
...
function Landing({ Stage = null }) {
  ...
  return (
    <div className="bg-[#09090B] font-body text-[#FAFAFA] antialiased">
      ...
      {Stage ? <Stage /> : <DeferredHouseStageV8 />}
      <main className="relative z-10">
        <StoryV21 storyRef={storyRef} />
...
function ServicesStageGate() {
  ...
  return show ? <DeferredHouseStageV8 scene="services" /> : null;
}

// V13 preserves AppV12 and applies only the versioned normal-phone scene scale.
