      ...
      <main className="mx-auto max-w-4xl px-6 pb-24 pt-16 md:px-10 md:pb-32">
        ...
        <div className="mt-12 space-y-9 rounded-[22px] border border-white/10 bg-white/[0.045] p-6 text-base leading-relaxed text-white/75 backdrop-blur-xl sm:p-10">
          <section>
            ...
            <p className="mt-3">This website does not create customer accounts or store contact-form submissions. The enquiry button opens your own email application. Your message is sent to Oak Park Construction only if you choose to send it.</p>
          </section>
          <section>
          ...
          <p className="border-t border-white/10 pt-6 font-mono text-[10px] uppercase tracking-[0.2em] text-white/45">Last updated August 19, 2026</p>
        </div>
      </main>
      <FooterV2 />
    </div>
