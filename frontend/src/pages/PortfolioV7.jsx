...
export default function PortfolioV7() {
  ...
  return <div data-testid="portfolio-page" className="min-h-screen bg-[#09090B] pt-16 text-[#FAFAFA]">
    ...
    <main className="mx-auto grid max-w-7xl scroll-mt-32 grid-cols-1 gap-5 px-6 py-10 md:grid-cols-2 md:px-10 md:py-14">{shown.map((project, index) => <ProjectCard key={project.id} project={project} index={index} />)}</main>
