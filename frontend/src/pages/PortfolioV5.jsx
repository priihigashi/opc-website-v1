...
export default function PortfolioV5() {
  ...
  return <div data-testid="portfolio-page" className="min-h-screen bg-[#09090B] pt-16 text-[#FAFAFA]">
    <header className="relative min-h-[calc(100svh-4rem)] overflow-hidden border-b border-white/10">
      <img src="/video/portfolio-hero-intro-poster.jpg" alt="Oak Park Construction completed interior work" width="1280" height="720" fetchPriority="high" className="absolute inset-0 h-full w-full object-cover" />
      <video data-testid="portfolio-hero-video" aria-hidden autoPlay muted loop playsInline preload="metadata" poster="/video/portfolio-hero-intro-poster.jpg" className="absolute inset-0 hidden h-full w-full object-cover motion-reduce:hidden sm:block">
        <source src="/video/portfolio-hero-intro.mp4" type="video/mp4" />
      </video>
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(9,9,11,0.91)_0%,rgba(9,9,11,0.56)_46%,rgba(9,9,11,0.22)_100%)]" />
      <div className="absolute inset-0 bg-gradient-to-t from-[#09090B] via-transparent to-black/35" />
