...
export const SERVICE_CONTENT = {
  ...
  "outdoor-living": {
    ...
    image: "/images/opc/outdoor-kitchen-dusk.jpg",
    phase: "Finished OPC work",
  },
  "concrete-pavers": {
    ...
    <div data-testid={`service-${slug}`} className="relative z-10 min-h-screen bg-[#09090B] pt-16 text-[#FAFAFA]">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-12 items-center gap-y-12 px-6 pb-24 md:px-10">
        ...
        >
          ...
          <p className="mt-6 max-w-md text-base leading-relaxed text-[#D4D4D8]">{s.body}</p>
        ...
        >
          <div className="relative">
            ...
            <figcaption className="absolute bottom-0 left-0 bg-[#09090B]/90 px-4 py-3 font-mono text-[10px] uppercase tracking-[0.22em] text-[#CBCC10]">
              {s.phase}
            </figcaption>
          </div>
        </motion.figure>
