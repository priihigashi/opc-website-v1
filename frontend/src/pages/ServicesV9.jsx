...
export default function ServicesV9() {
  ...
  return (
    ...
    >
      <section className="mx-auto flex min-h-[100svh] w-full max-w-[110rem] flex-col px-4 pb-5 pt-20 sm:px-6 md:px-8 md:pb-8 md:pt-24 xl:px-12">
        ...
        <div data-testid="services-house-space-v1" className="services-spacer-v2 min-h-[34svh] flex-1 sm:min-h-[38svh] md:min-h-0" aria-hidden="true" />
