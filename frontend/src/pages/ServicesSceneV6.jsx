...
import ServicesHouseSceneV1 from "@/three/ServicesHouseSceneV1";
...
export default function ServicesSceneV6({ onFrame = null, onContextLost = null }) {
  const { pathname } = useLocation();

  useEffect(() => {
    scrollStore.intro = 1;
    const slug = pathname.split("/")[2];
    const service = SERVICES_V4_BY_SLUG[slug];
  ...
  return (
    <div data-testid="services-scene-v6">
      <ServicesHouseSceneV1 onFrame={onFrame} onContextLost={onContextLost} />
    </div>
  );
}
