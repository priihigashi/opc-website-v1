...
export default function PortfolioV6() {
  ...
  return <div data-testid="portfolio-page" className="min-h-screen bg-[#09090B] pt-16 text-[#FAFAFA]">
    <header className="relative min-h-[calc(100svh-4rem)] overflow-hidden border-b border-white/10">
      ...
      <div className="relative mx-auto flex min-h-[calc(100svh-4rem)] max-w-7xl flex-col justify-end px-6 pb-20 pt-14 md:px-10 md:pb-24">
        ...
        <a href="#portfolio-filters" className="absolute bottom-5 left-1/2 flex -translate-x-1/2 flex-col items-center gap-1 font-mono text-[9px] uppercase tracking-[0.24em] text-white/85 transition-colors hover:text-[#CBCC10]"><span>View Projects</span><ChevronDown aria-hidden className="h-4 w-4" /></a>
      </div>
    </header>
