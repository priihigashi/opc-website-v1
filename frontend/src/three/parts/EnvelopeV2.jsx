...
// Envelope v2 uses true butt joints. Front/back faces own the outer corners;
// perpendicular walls stop at their inner faces, so no boxes overlap and no
// cosmetic closure strips are needed.
export default function EnvelopeV2({ mats, reg }) {
  const frontOpenings = shiftOpenings([
  ...
  return (
    <group name="exterior-finishes-v2">
      <group name="facade-front-a-v2" ref={reg("finFrontA")} position={[-3.5, 0.5, 3]}>
