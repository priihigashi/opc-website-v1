...
// Envelope v3 uses true butt joints. Front/back faces own the outer corners;
...
// separate from the shifted window grid so it matches the wood door exactly.
export default function EnvelopeV3({ mats, reg }) {
  const frontOpenings = [
  ...
  return (
    <group name="exterior-finishes-v3">
      <group name="facade-front-a-v3" ref={reg("finFrontA")} position={[-3.5, 0.5, 3]}>
