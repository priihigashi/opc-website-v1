...
const PLANTERS = [
  ...
  { x: 2.35, z: 0.5, width: 1.7 },
];

// Ch.05 hardscape: a clear entry path with three intentional landscape masses.
export default function DrivewayV2({ mats, reg }) {
  ...
  return (
    <group name="driveway-pavers-v2" ref={reg("drivewayGroup")} position={[0, 0, 3.3]} visible={false}>
