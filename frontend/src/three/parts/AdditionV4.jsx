...
// Addition v4: preserves the closed butt-joint envelope from v3 while treating
// the side entry like the main wood door. The wood slab slightly overlaps the
// opening and sits just proud of the stucco; no black perimeter frame is used.
export default function AdditionV4({ mats, reg }) {
  return (
    <group name="addition-v4" ref={reg("additionGroup")} position={[6, 0, -0.68]} visible={false}>
