...
const ENVELOPE = {
  pavilionRoofX: 3.08,
  pavilionRoofWidth: 8.14,
  pavilionReturnHeight: 3.4,
  pavilionReturnCenterY: 1.7,
  towerWestWallLength: 6.25,
  towerEastUpperDepth: 6.25,
  towerWestCornerClosure: 0.125,
};
...
export default function HouseModelV8() {
