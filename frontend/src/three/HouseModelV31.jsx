...
// V31 preserves V30 and applies the Council's 0.16-unit left bias only at wide desktop.
export default function HouseModelV31({ onFrame = null }) {
  ...
  return (
    <HouseModel
      ...
      desktopChapterScale={0.96}
      desktopPositionFactor={1.12}
    />
  );
}
