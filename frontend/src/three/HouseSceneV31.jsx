...
import HouseModelV29 from "./HouseModelV29";
...
// V31 preserves V30 camera, lighting and clipping, routing only through V29.
export default function HouseSceneV31({ onFrame = null }) {
  return (
    <div className="fixed inset-0 z-0" data-testid="house-scene" aria-hidden>
      ...
      >
        ...
        <Suspense fallback={null}><HouseModelV29 onFrame={onFrame} /></Suspense>
