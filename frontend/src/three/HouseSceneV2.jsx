...
import HouseModelV2 from "./HouseModelV2";
...
export default function HouseSceneV2() {
  return (
    <div className="fixed inset-0 z-0" data-testid="house-scene" aria-hidden>
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 46% at 72% 47%, rgba(186,135,72,0.14), rgba(203,204,16,0.045) 42%, rgba(9,9,11,0) 72%)",
        }}
      />
      <Canvas
        shadows="basic"
