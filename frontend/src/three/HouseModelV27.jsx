...
// Evidence-triggered mobile separation only: preserve the hero scale, then settle
// the house into a smaller upper reading zone before the first banner reaches focus.
const MOBILE_SCALE = [[0, 0.78], [0.004, 0.78], [0.10, 0.62], [0.14, 0.46], [0.912, 0.46], [1, 0.56]];
const VIEW = {
  phone: { f: 0.04, s: 0.5, y: 2.8 },
...
export default function HouseModelV27({ onFrame = null }) {
