  ...
  return (
    <div className="fixed inset-0 z-0" data-testid="house-scene" aria-hidden>
      ...
      <Canvas
        ...
        onCreated={({ camera, gl }) => { camera.lookAt(0, 1.15, 0); gl.shadowMap.type = THREE.PCFSoftShadowMap; window.__cam = camera; }}
      >
        ...
        <EffectComposer multisampling={0}>
          <N8AO intensity={0.62} aoRadius={0.58} distanceFalloff={2.2} quality="medium" />
          <SMAA />
        </EffectComposer>
      </Canvas>
    </div>
