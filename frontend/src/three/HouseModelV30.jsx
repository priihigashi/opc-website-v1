...
const DEFAULT_SHELL_FINISH = { facadeFade: 0.55, facadeSeparation: 1.2 };
const PHONE_SHELL_FINISH = { facadeFade: 0.6, facadeSeparation: 1.35 };
...
// V30 preserves V29 and opts normal phones into the bounded Chapter 01 facade
// treatment. All other viewport profiles use the shared engine defaults.
export default function HouseModelV30({ onFrame = null }) {
  ...
  const shellFinishConfig = stage.phone && !stage.shortPhone ? PHONE_SHELL_FINISH : DEFAULT_SHELL_FINISH;
  ...
  return (
    <HouseModel
      ...
      shellFinishConfig={shellFinishConfig}
    />
  );
}
