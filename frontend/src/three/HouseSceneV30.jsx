...
import HouseModelV28 from "./HouseModelV28";
...
// V30 preserves the approved V19 scene and enables local clipping for the
// V28 mobile-only descending-facade ground mask.
export default function HouseSceneV30({ onFrame = null }) {
  return (
    <div className="fixed inset-0 z-0" data-testid="house-scene" aria-hidden>
      <div
        className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(ellipse 50% 46% at 72% 47%, rgba(186,135,72,0.14), rgba(203,204,16,0.045) 42%, rgba(9,9,11,0) 72%)" }}
      />
      <Canvas
        shadows="soft"
        dpr={[1, 1.7]}
        camera={{ fov: 38, position: [2.1, 4.75, 14.8] }}
        gl={{
          antialias: true,
      ...
      >
        ...
        <Suspense fallback={null}><HouseModelV28 onFrame={onFrame} /></Suspense>
