...
import HouseModelV26 from "./HouseModelV26";
...
export default function HouseSceneV28({ ModelComponent = HouseModelV26 }) {
  return (
    <div className="fixed inset-0 z-0" data-testid="house-scene" aria-hidden>
      <div
        className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(ellipse 50% 46% at 60% 47%, rgba(186,135,72,0.14), rgba(203,204,16,0.045) 42%, rgba(9,9,11,0) 72%)" }}
      />
      <Canvas
        shadows="soft"
        dpr={[1, 1.7]}
