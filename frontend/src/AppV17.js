...
import StoryV22 from "@/components/StoryV22";
...
const ProjectGallery = lazy(() => import("@/pages/ProjectGalleryV5"));
...
function Landing({ Stage = null }) {
  ...
  return <div className="bg-[#09090B] font-body text-[#FAFAFA] antialiased"><div className="noise-overlay" aria-hidden />{Stage ? <Stage /> : <DeferredHouseStageV12 />}<main className="relative z-10"><StoryV22 storyRef={storyRef} /><div className="relative border-t border-white/10 bg-[#09090B]"><MarqueeV2 /><AboutV3 /><GalleryV4 /><TestimonialsV3 /><ContactV7 /><FooterV3 /></div></main></div>;
}
...
// V17 preserves AppV16 and fixes only project-detail route entry position.
