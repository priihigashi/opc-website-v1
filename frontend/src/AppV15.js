...
import DeferredHouseStageV11 from "@/components/DeferredHouseStageV11";
...
function Landing({ Stage = null }) {
  ...
  return <div className="bg-[#09090B] font-body text-[#FAFAFA] antialiased"><div className="noise-overlay" aria-hidden />{Stage ? <Stage /> : <DeferredHouseStageV11 />}<main className="relative z-10"><StoryV22 storyRef={storyRef} /><div className="relative border-t border-white/10 bg-[#09090B]"><MarqueeV2 /><AboutV3 /><GalleryV4 /><TestimonialsV3 /><ContactV7 /><FooterV3 /></div></main></div>;
}
...
function ServicesStageGate() {
  ...
  return show ? <DeferredHouseStageV11 scene="services" /> : null;
}
...
// V15 preserves V14 and activates only the versioned desktop spacing chain.
