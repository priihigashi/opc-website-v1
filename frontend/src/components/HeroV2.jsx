...
export default function HeroV2() {
  return (
    <section
      id="top"
      data-testid="hero"
      className="pointer-events-none relative flex h-screen flex-col justify-between overflow-hidden"
    >
      ...
      >
        ...
        <h1 className="mt-6 max-w-5xl leading-[0.86] text-[#EEEDE9]">
          <span className="block overflow-hidden pb-2">
            <motion.span
              variants={lineUp}
              className="font-head block text-6xl uppercase tracking-[-0.025em] [text-shadow:0_4px_38px_rgba(0,0,0,0.96)] sm:text-8xl lg:text-[7.2rem]"
          ...
          <span className="block overflow-hidden pb-3">
            <motion.span
              variants={lineUp}
              className="font-editorial block pl-[0.03em] text-5xl font-medium tracking-[-0.045em] text-[#EEEDE9] [text-shadow:0_4px_38px_rgba(0,0,0,0.96)] sm:text-7xl lg:text-[6.8rem]"
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative mx-auto flex w-full max-w-7xl items-end justify-between gap-8 px-6 pb-7 md:px-10 md:pb-12"
      >
        <div className="max-w-[36rem]">
          <p
            data-testid="hero-sub"
            className="max-w-xl text-sm leading-[1.75] text-[#EEEDE9]/90 [text-shadow:0_2px_18px_rgba(0,0,0,1)] md:text-[0.98rem]"
          >
            Scroll through the house to see what we build—from structural shells and
            remodels to additions, outdoor living, concrete and pavers.
          </p>
        </div>
        <a
          href="#ch-01"
        ...
        >
          Scroll to explore <span className="text-[#CBCC10]" aria-hidden>↓</span>
        </a>
      </motion.div>
    </section>
  );
