...
const ServicesHouse = lazy(() => import("@/pages/ServicesSceneV6"));
  ...
  return (
    ...
    >
      <img
        ...
        width="1116"
        height="614"
        className={isHome ? "h-auto w-[min(78vw,46rem)] object-contain opacity-80 [mask-image:radial-gradient(ellipse_72%_68%_at_center,black_56%,transparent_100%)]" : "max-h-[80%] w-auto max-w-[80%] object-contain opacity-80"}
      />
...
export default function DeferredHouseStageV13({ scene = "home" }) {
