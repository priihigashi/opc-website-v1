...
const chapterContent = [
  {
    ...
    recentProject: {
      src: "/images/opc/bones-framing-v1",
      w: 1600, h: 1200, widths: [480, 768, 1200, 1600],
      alt: "Structural framing and temporary roof supports during a residential renovation", phase: "DURING", orientation: "landscape",
    },
  },
  {
...
// V22 preserves V21 and applies the shared measured desktop card/rail lanes.
// V24 preserves V23 and makes the accepted cue continuous across the chapter range.
export default function StoryV24({ storyRef }) {
  return (
    <div ref={storyRef} data-testid="story" className="story-cue-v6-layout relative">
      <ChapterRailV3 chapters={chapters} />
      <StoryBannerRailV6 chapters={chapters} />
      <HeroV10 />
      <StoryCueRangeV1>
        {chapters.map((chapter) => <ChapterV9 key={chapter.id} {...chapter} />)}
      </StoryCueRangeV1>
