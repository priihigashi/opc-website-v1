...
import { ChapterV5 } from "./ChapterV5";
import ChapterRail from "./ChapterRail";
import ScrollDownCueV3 from "./ScrollDownCueV3";
import StoryBannerRailV2 from "./StoryBannerRailV2";
...
// V18 adds one verified Recent Project image inside each existing service card.
export default function StoryV18({ storyRef }) {
  return (
    <div ref={storyRef} data-testid="story" className="relative">
      <ChapterRail />
      <ScrollDownCueV3 />
      <StoryBannerRailV2 chapters={chapters} />
      <HeroV10 />
      {chapters.map((chapter) => <ChapterV5 key={chapter.id} {...chapter} />)}
