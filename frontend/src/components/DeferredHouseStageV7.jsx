...
const HomeHouse = lazy(() => import("@/three/HouseSceneV30"));
...
// V7 preserves V6 lifecycle/fallback behavior and routes only the home scene
// through HouseSceneV30. The Services scene remains exactly V5.
export default function DeferredHouseStageV7({ scene = "home" }) {
  ...
  return (
    <>
      ...
      {!showStatic ? (
        <div className={`fixed inset-0 z-0 transition-opacity duration-200 ${isRevealed(interactiveReady, interactiveFailed) ? "opacity-100" : "opacity-0"}`} data-testid="house-interactive-gate-v4">
