...
import { ChapterV6 } from "./ChapterV6";
import ChapterRailV2 from "./ChapterRailV2";
import ScrollDownCueV4 from "./ScrollDownCueV4";
import StoryBannerRailV3 from "./StoryBannerRailV3";
...
// V20 preserves V19 and changes only the first-fold arrow to a slow opacity pulse.
export default function StoryV20({ storyRef }) {
  return (
    <div ref={storyRef} data-testid="story" className="relative">
      <ChapterRailV2 chapters={chapters} />
      <ScrollDownCueV4 />
      <StoryBannerRailV3 chapters={chapters} />
      <HeroV10 />
      {chapters.map((chapter) => <ChapterV6 key={chapter.id} {...chapter} />)}
