...
const HomeHouse = lazy(() => import("@/three/HouseSceneV31"));
...
// V8 preserves V7 lifecycle, fallback and Services behavior and routes only the
// interactive home scene through HouseSceneV31.
export default function DeferredHouseStageV8({ scene = "home" }) {
