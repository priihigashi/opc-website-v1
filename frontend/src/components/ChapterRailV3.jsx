...
// V3 preserves every V2 anchor behavior and uses the measured desktop edge reserve.
export default function ChapterRailV3({ chapters }) {
  ...
  return (
    <nav ref={navRef} aria-label="Build chapters" aria-hidden={visible ? undefined : "true"} className={`transition-opacity duration-300 ${visible ? "opacity-100" : "pointer-events-none opacity-0"}`}>
      <div data-testid="chapter-rail-desktop" className="fixed right-3 top-1/2 z-30 hidden w-[114px] -translate-y-1/2 xl:block">
