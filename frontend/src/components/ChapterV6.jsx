...
/** V6 keeps reduced-motion chapters in normal document flow with the project image inside the card. */
export function ChapterV6({ side, timing, ...cardProps }) {
  ...
  return (
    <section id={cardProps.id} data-testid={cardProps.id} className="pointer-events-none relative flex min-h-[100svh] items-end px-4 pb-16 pt-24 min-[768px]:items-center min-[768px]:px-6 min-[1100px]:px-10">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-12">
        <div className={`col-span-12 mx-auto w-full max-w-[430px] min-[768px]:mx-0 min-[768px]:w-[min(36vw,360px)] min-[1100px]:w-[clamp(340px,28vw,430px)] ${lane}`}>
          <ChapterCardV3 {...cardProps} interactive />
        </div>
      </div>
    </section>
  );
