...
import StoryV23 from "@/components/StoryV23";
...
const Portfolio = lazy(() => import("@/pages/PortfolioV9"));
const ProjectGallery = lazy(() => import("@/pages/ProjectGalleryV6"));
...
function Landing({ Stage = null }) {
  ...
  return <div className="bg-[#09090B] font-body text-[#FAFAFA] antialiased"><div className="noise-overlay" aria-hidden />{Stage ? <Stage /> : <DeferredHouseStageV12 />}<main className="relative z-10"><StoryV23 storyRef={storyRef} /><div className="relative border-t border-white/10 bg-[#09090B]"><MarqueeV2 /><AboutV3 /><GalleryV4 /><TestimonialsV3 /><ContactV7 /><FooterV3 /></div></main></div>;
}
...
function ServicesStageGate() {
  ...
  return show ? <DeferredHouseStageV12 scene="services" /> : null;
}

// Candidate 5 keeps the house/loading/navigation behavior and simplifies gallery identity.
