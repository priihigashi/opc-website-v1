...
PRIMARY_TAG = {
    ...
    # Launch audit 2026-08-24: Opa Locka Airport is concrete-repair documentation,
    # not a commercial build-out. Published category is CONCRETE.
    "Opa Locka Airport": "CONCRETE",
}

# Public scope wording overrides where the folder-derived scope word would mislabel
# the actual work. Same launch-audit correction as PRIMARY_TAG above.
DETAIL_OVERRIDE = {
    "Opa Locka Airport": "Concrete Repair",
}
...
for name, p in projects.items():
    ...
    out.append({
        ...
        "detail": DETAIL_OVERRIDE.get(name, scope_words),
