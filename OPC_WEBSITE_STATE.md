...
Last updated: 2026-09-04 17:40 EDT (America/New_York)

## Canonical release line

- Current numbered release: **Candidate 3 — Discreet House Loading**.
- Canonical branch: `release/opc-launch-today-2026-09-04`.
- Frozen website code commit: `50b7bbd6338dccf86562ef2844f7c5f07a299f2b`.
- Exact immutable preview: `https://opc-house-elements-review-chfvxisjr-priihigashis-projects.vercel.app`.
- Vercel deployment: `dpl_6jBBZGuCYy4pr7ZisRyVqosdyMpj` (`READY`, preview target).
...
- Priscila must approve the Candidate 3 appearance.
