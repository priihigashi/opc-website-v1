...
Lab banner cache-bust: **?v=17** (bump to ?v=18 on next page added)
...
| 2026-06-24 | **digitalists** (Austrian digital agency) | [digitalists.at](https://digitalists.at) | Clean modern agency site — minimal fixed nav, big background-image hero w/ bold headline + **yellow accent #F1E500** (≈ OPC lime #CBCC10), 8-card services grid, case-studies carousel, inline contact form w/ 30-min consult CTA. **Priscila likes TWO PARTS — ⏳ awaiting which two.** (Tracker Inspiration row 41) |
...
- **2026-06-24** — INSPO SAVED (RULE 2): `https://digitalists.at` (Austrian digital agency) added to Tracker → Inspiration Links row 41 + state.md Inspiration table. Fetched + summarized the homepage (minimal nav, yellow-accent bg-image hero, 8-card services grid, case-studies carousel, inline contact form). Priscila likes TWO specific parts — saved with "⏳ awaiting which two" flag; will update both rows once she names them.
